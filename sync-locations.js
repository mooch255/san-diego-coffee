...
async function main() {
  ...
  // ── 5b. Write location-count.js — single source of truth for the footer count ──
  const countOutput = `// Auto-generated by sync-locations.js — do not edit manually.\nwindow.LOCATION_COUNT = ${locations.length};\n(function(){function a(){var e=document.getElementById('footerCount');if(e)e.textContent=window.LOCATION_COUNT;}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',a);}else{a();}})();\n`;
  fs.writeFileSync(path.join(__dirname, 'location-count.js'), countOutput, 'utf8');
  console.log(`  ✓ location-count.js updated (${locations.length})`);
